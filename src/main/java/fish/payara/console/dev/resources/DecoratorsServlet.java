...
/**
 * Servlet exposing CDI decorator metadata and runtime statistics
 * for the Dev Console.
 *
 * <p>
 * This servlet provides both a summary view of
 * all decorators and a detailed view for an individual decorator.
 * </p>
 *
 ...
 *       {@link fish.payara.console.dev.dto.DecoratorDTO}.</li>
 *
 *   <li><b>GET /cdi/decorators/{className}</b><br>
 *       Returns full metadata and invocation statistics for the
 *       specified decorator as
 *       {@link fish.payara.console.dev.dto.DecoratorDTO}.</li>
 * </ul>
 *
 ...
 * output consistent with the former JAX-RS implementation.
 * </p>
 *
 ...
 *   <li>Routing is performed based on the request path to distinguish
 *       between list and detail requests.</li>
 * </ul>
 *
 ...
 *   <li>{@code 404 Not Found} is returned if the requested decorator
 *       class cannot be found.</li>
 * </ul>
 *
 * @author Gaurav Gupta
 */
@WebServlet("/cdi/decorators/*")
public class DecoratorsServlet extends AbstractConsoleServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        getDecoratorByClassName(className, resp);
    }
    ...
    private void listDecorators(HttpServletResponse resp)
            throws IOException {
    ...
    private void getDecoratorByClassName(String className,
