 ...
 * <p>
 * This servlet exposes bean-centric operations
 * using JSON-B for type-safe serialization.
 *
 ...
 *       Returns full metadata and lifecycle statistics for a single bean,
 *       identified by its fully-qualified class name, as {@link BeanDTO}.</li>
 *
 *   <li><b>GET /cdi/beans/{id}/injection-points</b><br>
 *       Returns all injection points belonging to the given bean as a list
 *       of {@link InjectionPointDTO}.</li>
 * </ul>
 *
 * <h2>Design notes</h2>
 *
 ...
 *   <li>Access is guarded by {@link AbstractConsoleServlet#guard(HttpServletResponse)};
 *       if the Dev Console is disabled, all endpoints return {@code 404 Not Found}.</li>
 * </ul>
 *
...
public class BeansServlet extends AbstractConsoleServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (path.endsWith(INJECTION_POINTS_SUFFIX)) {
            ...
            getInjectionPointsForBean(beanClass, resp);
            return;
        }

        // GET /cdi/beans/{id}
        getBeanById(path.substring(1), resp);
    }
    ...
    private void listBeans(HttpServletResponse resp) throws IOException {
    ...
    private void getBeanById(String className, HttpServletResponse resp)
            throws IOException {
    ...
    private void getInjectionPointsForBean(String beanClass,
