...
public class DecoratorDTO extends DecoratorInfo {
    ...
    private List<fish.payara.console.dev.model.Record> invocationRecords;
    ...
    public List<fish.payara.console.dev.model.Record> getInvocationRecords() {
        return invocationRecords;
    }

    public void setInvocationRecords(List<fish.payara.console.dev.model.Record> invocationRecords) {
